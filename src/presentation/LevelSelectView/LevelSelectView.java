...
public class LevelSelectView extends BorderPane{
	...
	public LevelSelectView(ArrayList<Level> levelArray) {
		...
		rightBox = new VBox();
		rightBox.getChildren().addAll(selectButton);
		...
		topBox.setPadding(new Insets(40, 5, 10, 105));	// padding for top box, title is in line with level box horizontally 155
